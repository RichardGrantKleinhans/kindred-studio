...
- The student's curiosity drives the curriculum.`,
  finnish: `PEDAGOGICAL PHILOSOPHY: Finnish National Curriculum (OPH)
...
- Equity means every student gets what they need, not what's average.`,
  montessori: `PEDAGOGICAL PHILOSOPHY: Montessori (AMI)
...
- No external rewards or grades. Intrinsic motivation only.`,
  reggio: `PEDAGOGICAL PHILOSOPHY: Reggio Emilia
...
- Provocation over instruction — pose questions that spark investigation.`,
  waldorf: `PEDAGOGICAL PHILOSOPHY: Waldorf / Steiner
...
- No standardized testing. Portfolio and narrative assessment only.`,
  forest: `PEDAGOGICAL PHILOSOPHY: Forest School / Friluftsliv
...
- Process over product — the journey of exploration matters more than the answer.`,
  swedish: `PEDAGOGICAL PHILOSOPHY: Swedish National Curriculum (Lgr22 / Skolverket)
...
- Critical thinking and source evaluation are core skills at every level.`,
  norwegian: `PEDAGOGICAL PHILOSOPHY: Norwegian National Curriculum (LK20)
...
- Interdisciplinary topics: health, democracy, sustainability woven through all subjects.`,
  nz: `PEDAGOGICAL PHILOSOPHY: Te Whāriki (New Zealand)
...
- The child's identity, language, and culture are central to learning.`,
  ib: `PEDAGOGICAL PHILOSOPHY: International Baccalaureate
...
- Assessment includes both formative and summative, with student reflection.`,
  competency: `PEDAGOGICAL PHILOSOPHY: Competency-Based Education
...
- Formative feedback is continuous. Summative assessment is criterion-referenced.`,
  classical: `PEDAGOGICAL PHILOSOPHY: Classical Education (Trivium)
...
2. A "Big Question" — the driving inquiry
3. Key concepts (3-5, appropriate for level)
4. A brief engaging introduction that hooks the student through their interests
5. Core content — teach something real, at the frontier of what's known
6. A "Wonder Moment" — one mind-blowing fact or connection
...
2. Lets the student explore through their interests
3. Has multiple entry points (not one right answer)
4. Includes a creative/expressive component
5. Can be completed in 20-40 minutes
6. For students with specific needs, naturally accommodates without labeling
...
2. Uses multiple modalities (not just written answers)
3. Includes self-reflection prompts ("What surprised you?", "What do you want to explore next?")
4. Frames everything as exploration, not testing
5. Provides clear rubric categories focused on depth of thinking
6. Identifies natural "next steps" for continued learning
    ...
    <div style={{
      ...
      <style>{`
        ...
        * { box-sizing: border-box; }
        body { margin: 0; }
        ::selection { background: ${WARM.emberGlow}; color: ${WARM.ember}; }
      `}</style>
      <div ref={topRef} />
